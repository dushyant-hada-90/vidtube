        ...
        [
...

            {
                $lookup:{
                    ...
                    as:"subscribers" //these people have subscribed to my channel
                }
            },

            {
                $lookup:{
                    ...
                    as:"subscribedTo" //these are channels i have subscribed to
                }
            },
...
const getwatchHistory = asyncHandler(async(req,res)=>{
    ...
    return res.status(200).json(new ApiResponse(200,user[0]?.watchHistoryDetails,"watch history fetched successfully"))
})
